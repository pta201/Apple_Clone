...
namespace Apple_Clone_Website.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Category).Include(p => p.ProductColor).Include(p => p.Supplier);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ProductColorID = new SelectList(db.ProductColors, "ProductColorID", "Color");
        ...
        public ActionResult Create([Bind(Include = "ProductID,Name,UnitPrice,Description,IsNew,CreatedAt,UpdatedAt,IsDeleted,CategoryID,SupplierID,Image,ProductColorID")] Product product)
        {
            ...
            ViewBag.ProductColorID = new SelectList(db.ProductColors, "ProductColorID", "Color", product.ProductColorID);
